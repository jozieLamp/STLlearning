...
for i in range(11):
    ...
    l = Learning(logging.INFO, "../Data/Card/cardDataChanges.txt", "../Data/Card/cardDeathLabels.txt",
    ...
    nameScores = "CardChangesRuleScoresDeath" + str(i)  + ".txt"
    ...
    nameRules = "CardChangesRuleDeath" + str(i)  + ".txt"
    ...
    l = Learning(logging.INFO, "../Data/Card/cardDataChanges.txt", "../Data/Card/cardRehospLabels.txt",
                 "../Data/Card/cardTimeChanges.txt", variables, lower, upper)
    ...
    # save rules and scores to file
    nameScores = "CardChangesRuleScoresRehosp" + str(i)  + ".txt"
    ruleScores = generation.finalFormulaScoresToString(500)
    with open(nameScores, 'w') as filehandle:
        for r in ruleScores:
            filehandle.write('%s\n' % r)
    ...
    nameRules = "CardChangesRuleRehosp" + str(i)  + ".txt"
    with open(nameRules, 'w') as filehandle:
        for r in rules:
            filehandle.write('%s\n' % r)
